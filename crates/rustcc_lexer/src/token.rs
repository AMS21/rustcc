...
impl TokenKind {
    ...
    pub const fn is_unary_operator(&self) -> bool {
        matches!(self, Self::Plus | Self::Minus | Self::Tilde | Self::Bang)
    }
    ...
    pub const fn binary_operator(&self) -> Option<BinaryOperator> {
        ...
        match self {
            ...
            Self::AmpersandAmpersand => Some(BinaryOperator::LogicalAnd),
            Self::Caret => Some(BinaryOperator::BitwiseXor),
            Self::Pipe => Some(BinaryOperator::BitwiseOr),
            Self::PipePipe => Some(BinaryOperator::LogicalOr),
            Self::Equals => Some(BinaryOperator::Assignment),
            Self::EqualsEquals => Some(BinaryOperator::Equals),
            Self::BangEquals => Some(BinaryOperator::NotEquals),
            Self::LessThan => Some(BinaryOperator::LessThan),
            Self::LessThanEqual => Some(BinaryOperator::LessThanOrEqual),
            Self::LessThanLessThan => Some(BinaryOperator::BitwiseLeftShift),
            Self::GreaterThan => Some(BinaryOperator::GreaterThan),
            Self::GreaterThanEqual => Some(BinaryOperator::GreaterThanOrEqual),
    ...
    pub const fn unary_operator(&self) -> Option<UnaryOperator> {
        ...
        match self {
            ...
            Self::Bang => Some(UnaryOperator::LogicalNot),
...
impl<'a> Token<'a> {
    ...
    pub fn new_identifier<R: Into<SourceRange<'a>>>(range: R) -> Self {
        ...
        assert!(!source_text.is_empty(), "Identifier cannot be empty");
    ...
    #[must_use]
    pub fn new_ampersand_ampersand<R: Into<SourceRange<'a>>>(range: R) -> Self {
        let range = range.into();
    ...
    #[must_use]
    pub fn new_equals<R: Into<SourceRange<'a>>>(range: R) -> Self {
        let range = range.into();
    ...
    #[must_use]
    pub fn new_equals_equals<R: Into<SourceRange<'a>>>(range: R) -> Self {
        let range = range.into();
    ...
    #[must_use]
    pub fn new_bang_equals<R: Into<SourceRange<'a>>>(range: R) -> Self {
        let range = range.into();
...
mod tests {
    ...
    fn is_unary_operator_flags_plus_minus_tilde() {
        ...
        assert!(
            TokenKind::Bang.is_unary_operator(),
            "! should be unary operator"
        );
